...
@WebServlet("/GestionAtracciones.do")

public class GestionAtraccionServlet extends HttpServlet implements Servlet {
...
private ServicioAtraccion servAtraccion;
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/gestionAtracciones.jsp");
