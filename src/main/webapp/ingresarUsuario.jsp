...
<body>
	<div class="container">
		...
		<section>
			...
			<form action="login" method="post">
				<div class="container bg-dark text-white">
					<p>Ingrese un nombre de usuario y una Contraseña</p>
				</div>
				...
				<div class="mb-3 row">
					<label for="password" class="col-sm-2 col-form-label">Contraseña:
					</label>
					<div class="col-sm-10">
				...
				<button class="btn-info" name="btnReg" type="submit">Ingresar</button>
			</form>
		...
		<aside>
			...
			<div>
				<img src="img/imagen.jpg" width="100" height="120" class="img-fluid">
			</div>
			<p>Accedera a los mejores precios, mejores ofertas y todas las
				promociones</p>
		</aside>
		<footer> &copy Proyecto Tierra Media. </footer>

	</div>
</body>
</html>
<button class="btn-info" name="btnReg">Ingresar</button>

</section>
<aside>
	<p>Ingrese con su cuenta y acceda a los mejores precios</p>
	<div>
		<img src="img/ingresar.jpg" width="100" height="120" class="img-fluid">
	</div>
	<p>Acceda a los mejores precios, mejores ofertas y todas las
		promociones que le dispone este servicio</p>
</aside>
