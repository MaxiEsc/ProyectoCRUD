...
<!--Fin de ventana modal-->   
  ...
  <section> 
    ...
    <div class="container">
		<button class="btn btn-info">Lista de Usuarios: </button>
	</div>
		...
		<table class="table table">
			<thead>
			  <tr>
				...
				<th scope="col">Nombre Conpleto</th>
				<th scope="col">Monedas</th>
				<th scope="col">Tiempo</th>	
			  </tr>
			</thead>
			<tbody>
			  <c:forEach var="usuarios" items="${usu}">
              <tr>
                <td><c:out value="${ usuarios.id_Usuario }"></c:out></td>
                <td><c:out value="${ usuarios.nombre_completo }"></c:out></td>
                <td><c:out value="${ usuarios.monedas }"></c:out></td>
                <td><c:out value="${ usuarios.tiempo }"></c:out></td>
              </tr>
             </c:forEach>
			</tbody>
		  </table>
	...
	<div class="container">		
		...
		<button class="btn btn-info"><div class="container">
			<a href="modificarUsuario.jsp">Modificar un Usuario</a>
		</div>
		</button>
		<button class="btn btn-info"><div class="container">
			<a href="borrarUsuario.jsp">Eliminar un Usuario</a>
		</div>
		</button>
	</div>
