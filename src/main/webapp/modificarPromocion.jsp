...
<!--Fin de ventana modal-->   
  ...
  <section> 
	...
	<div class="container"> 
		<p>Ingrese los datos necesarios para modificar a una Promocion</p>
	</div>

    <form action="modificarPromocion.do" method="post" class="form-check">
        <div class="mb-3 row">
            <label for="password" class="col-sm-2 col-form-label">Id Promocion: </label>
            <div class="col-sm-10">
              <input type="number" class="form-control" name="numIdPromocion" >
            </div>
        </div>
	    <div class="mb-3 row ">
		<label for="text" class="col-sm-2 col-form-label">Nombre: </label>
		<div class="col-sm-10">
		  <input type="text" class="form-control" name="nomPromocion" >
		</div>
	  </div>
      <div class="mb-3 row ">
		<label for="text" class="col-sm-2 col-form-label">Tipo: </label>
		<div class="col-sm-10">
		  <input type="text" class="form-control" name="nomTipo" >
		</div>
	  </div>
      <div class="mb-3 row">
		<label for="password" class="col-sm-2 col-form-label">Descuento: </label>
		<div class="col-sm-10">
		  <input type="number" class="form-control" name="numDescuento" >
		</div>
	</div>
	  <div class="mb-3 row">
		<label for="password" class="col-sm-2 col-form-label">Precio: </label>
		<div class="col-sm-10">
		  <input type="number" class="form-control" name="numPrecio" >
		</div>
	</div>
    <div class="mb-3 row">
		<label for="password" class="col-sm-2 col-form-label">Atraccion Id Gratis: </label>
		<div class="col-sm-10">
		  <input type="number" class="form-control" name="numAtraccion_Id_Gratis" >
		</div>
	</div>
