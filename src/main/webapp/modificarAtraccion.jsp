...
<!--Fin de ventana modal-->   
  ...
  <section> 
	...
	<div class="container"> 
		<p>Ingrese los datos necesarios para modificar a una Atraccion</p>
	</div>

    <form action="modificarAtracciones.do" method="post" class="form-check">
    <div class="mb-3 row">
          <label for="monedas" class="col-sm-2 col-form-label">Id Atraccion: </label>
        <div class="col-sm-10">
          <input type="number" class="form-control" name="numIdAtraccion" >
        </div>
    </div>
	<div class="mb-3 row ">
		<label for="text" class="col-sm-2 col-form-label">Nombre: </label>
		<div class="col-sm-10">
		  <input type="text" class="form-control" name="nomAtraccion" >
		</div>
	  </div>
	  <div class="mb-3 row">
		<label for="password" class="col-sm-2 col-form-label">Valor: </label>
		<div class="col-sm-10">
		  <input type="number" class="form-control" name="numValor" >
		</div>
	</div>
    <div class="mb-3 row">
		<label for="password" class="col-sm-2 col-form-label">Duracion: </label>
		<div class="col-sm-10">
		  <input type="number" class="form-control" name="numDuracion" >
		</div>
	</div>
    
	<div class="mb-3 row">
		<label for="monedas" class="col-sm-2 col-form-label">Cupo: </label>
		<div class="col-sm-10">
		  <input type="number" class="form-control" name="numCupo" >
		</div>
	</div>
