...
<!--Fin de ventana modal-->   
  ...
  <section> 
	...
	<div class="container"> 
		<p>Ingrese los datos necesarios para eliminar a una Atraccion</p>
	</div>

    <form action="borrarAtracciones.do" method="post" class="form-check">
    <div class="mb-3 row">
          <label for="monedas" class="col-sm-2 col-form-label">Id Atraccion para eliminar: </label>
        <div class="col-sm-10">
