...
<!--Fin de ventana modal-->   
  ...
  <section> 
	...
	<div class="container"> 
		<p>Ingrese los datos necesarios para modificar a un Usuario</p>
	</div>

    <form action="modificarUsuario.do" method="post" class="form-check">
        <div class="mb-3 row ">
            <label for="text" class="col-sm-2 col-form-label">Id Usuario: </label>
            <div class="col-sm-10">
      ...
      <div class="mb-3 row ">
		...
		<div class="col-sm-10">
		  <input type="number" class="form-control" name="nomMonedas" >
		</div>
	  </div>
      <div class="mb-3 row">
