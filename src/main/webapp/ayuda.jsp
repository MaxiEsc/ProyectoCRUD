...
<!--Fin de ventana modal-->   
  ...
  <section> 
    ...
    <div class="container">
        ...
        <p>Como se ha dicho arriba de momento podra ingresar con su nombre de usuario igual a la contraseña  con eso en mente podra realizar operaciones de alta, baja, y modificacion de promociones atraccion e incluso usuarios</p>

        <h3>¿Como ver atracciones?</h3>
        
        <p>Seleccione la pestaña Atracciones y le cargara la actracciones presentes en el sistema, esta se ordenara de menor a mayor precio</p>

        <h3>¿Como ver las promociones?</h3>

		<p>Seleccione la pestaña Promociones y le cargara la promociones presentes en el sistema, esta se ordenara de menor a mayor precio</p>
